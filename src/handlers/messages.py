...
async def handle_message(client, message):
    ...
    for att in message.attachments:
        if "image" in att.content_type:
            ...
            if ext == "gif":
                if image_circler.circle_gif(f"/mnt/2tbdrive/projects/RoyBot/downloads/attachment-{roy_counter.roy_count + 1}.{ext}", "roy", success_dest=f"/mnt/2tbdrive/projects/RoyBot/downloads/attachment-{roy_counter.roy_count + 1}.png"):
            ...
            elif image_circler.circle_word(f"/mnt/2tbdrive/projects/RoyBot/downloads/attachment-{roy_counter.roy_count + 1}.{ext}", "roy") or image_circler.circle_face(f"/mnt/2tbdrive/projects/RoyBot/downloads/attachment-{roy_counter.roy_count + 1}.{ext}"):
                roy_counter.inc_count(roy_counter.roy_count)
